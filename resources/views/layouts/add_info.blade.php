        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('add-info') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('age') ? ' has-error' : '' }}">
                            <label for="text" class="col-md-4 control-label">Age</label>
                        ...
                        <div class="form-group">
                            <label for="password-confirm" class="col-md-4 control-label">Profession</label>
